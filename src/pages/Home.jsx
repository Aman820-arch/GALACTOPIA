    ...
    <div className="space-y-16 animate-in fade-in duration-500 flex flex-col min-h-[80vh] justify-between">
      <div className="space-y-16">
        ...
        <header className="max-w-2xl space-y-4">
          <h1 className="text-sm font-black tracking-[0.4em] text-emerald-500 uppercase select-none">
            GALACTOPIA
          </h1>
          <h2 className="text-4xl md:text-6xl font-black tracking-tight uppercase leading-[1.1] text-white select-none">
              ...
              <div className="flex flex-row flex-nowrap w-max gap-6 animate-marquee-loop hover:[animation-play-state:paused]">
                {movies.map((movie, idx) => (
                  <div 
                    ...
                    className="w-64 h-44 rounded-2xl border border-white/[0.04] bg-[#0c0c12] p-5 flex flex-col justify-between group hover:border-emerald-500/30 hover:bg-[#11111a] transition-all duration-300 cursor-pointer flex-shrink-0 relative overflow-hidden"
                  >
                    {movie.poster ? (
                      <div 
                    ...
                    <div className="flex justify-between items-start relative z-10">
                      <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded-lg backdrop-blur-sm">
                        {movie.tags}
                      </span>
                    </div>
